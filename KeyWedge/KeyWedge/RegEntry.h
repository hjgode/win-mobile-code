...
public:
	...
	__inline	UINT IsString()		{ return (iType == REG_SZ); }
	__inline	UINT IsDWORD()		{ return (iType == REG_DWORD); }
	__inline	UINT IsBinary()		{ return (iType == REG_BINARY); }	
	__inline	UINT IsMultiString() { return (iType == REG_MULTI_SZ); }

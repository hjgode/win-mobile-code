...
namespace OpenNETCF.IO.Serial
{
	...
	internal abstract class CommAPI
	{
		...
		internal virtual bool GetOverlappedResult(IntPtr hPort, IntPtr lpOverlapped, out Int32 lpNumberOfBytesTransferred, bool bWait) {lpNumberOfBytesTransferred = 0; return false;}
		#endregion
	...
	internal class WinCommAPI:CommAPI
	{
		...
		override internal bool GetOverlappedResult(IntPtr hPort, IntPtr lpOverlapped, out Int32 lpNumberOfBytesTransferred, bool bWait)
		{
